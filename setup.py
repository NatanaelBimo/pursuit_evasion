...
setup(
    ...
    entry_points={
        'console_scripts': ['turtle_tf2_broadcaster = pursuit_evasion.turtle_tf2_broadcaster:main','pursuer = pursuit_evasion.pursuer:main','evader = pursuit_evasion.evader:main'
                            ],
    },
)
